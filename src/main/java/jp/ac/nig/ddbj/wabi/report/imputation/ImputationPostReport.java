...
public class ImputationPostReport extends WabiPostReport {

	public ImputationPostReport(WabiJobInfo info, WabiRequest req) throws IOException {
		super(info, req);
	}

	public ImputationPostReport(ImputationJobInfo info, ImputationRequest req) throws IOException {
		super(info, req);
		this.put("status", "200");
