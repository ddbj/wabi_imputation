...
public class ImputationIllegalRequestReport extends WabiIllegalRequestReport {
	public ImputationIllegalRequestReport(WabiRequest req) {
		super(req);
	}

	public ImputationIllegalRequestReport(ImputationRequest req) {
		super(req);
	}

	public ImputationIllegalRequestReport(WabiGetRequest request) {
		super(request);
	}
