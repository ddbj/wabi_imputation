...
public class ImputationGetErrorReport extends WabiGetErrorReport {
	public ImputationGetErrorReport(WabiGetRequest req) {
		super(req);
	}

	public ImputationGetErrorReport(WabiGetenvRequest req) {
		super(req);
	}
}
