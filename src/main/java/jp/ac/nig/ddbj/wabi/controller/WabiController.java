...
public abstract class WabiController {
	...
	public static Pattern patternGetenvPermittedRemoteAddr
		= Pattern.compile(ConfWabi.patternGetenvPermittedRemoteAddr);
	public static Pattern patternGetResultOfQsubPermittedRemoteAddr
		= Pattern.compile(ConfWabi.patternGetResultOfQsubPermittedRemoteAddr);
	public static Pattern patternGetStatusOfQsubPermittedRemoteAddr
		= Pattern.compile(ConfWabi.patternGetStatusOfQsubPermittedRemoteAddr);
//	public static Pattern patternTestSecurityApplicationScanPagePermittedRemoteAddr
//		= Pattern.compile(ConfWabi.patternTestSecurityApplicationScanPagePermittedRemoteAddr);
	...
	public void initBinder(WebDataBinder binder) {
		 ...
		 */
		binder.setAllowedFields("dataFile", "parameters", "format", "result", "address",
								"format", "info",
	...
	/** gridengineにジョブを投入するbash scriptを作成する.
	 * 
	 * @param request
	 * @return
	 * @throws IOException 
